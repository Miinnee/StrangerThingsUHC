...
import static fr.mine.utils.AllUtils.color;

/**
 * {@inheritDoc}
 */
public class CustomBoard extends FastBoardBase<String> {
    ...
    public void updateLines(String... lines) {
        ...
        String[] coloredLines = colorizeLines(lines);
        super.updateLines(coloredLines);
    }

    private String[] colorizeLines(String... lines) {
        String[] coloredLines = new String[lines.length];
        for (int i = 0; i < lines.length; i++) {
            coloredLines[i] = color(lines[i]);
        }
        return coloredLines;
    }
